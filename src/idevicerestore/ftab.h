...
int ftab_parse(unsigned char *data, size_t data_size, ftab_t *ftab, uint32_t *tag);
int ftab_get_entry_ptr(ftab_t ftab, uint32_t tag, unsigned char **data, size_t *data_size);
int ftab_add_entry(ftab_t ftab, uint32_t tag, unsigned char *data, unsigned int data_size);
int ftab_write(ftab_t ftab, unsigned char **data, size_t *data_size);
